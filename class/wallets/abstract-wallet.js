import { BitcoinUnit, BitcoinilUnit, Chain } from '../../models/bitcoinUnits';
...
export class AbstractWallet {
  ...
  constructor(isIl = false) {
    ...
    this._isIl = isIl;
    if(isIl) {
      this.preferredBalanceUnit = BitcoinilUnit.BTC;
      this.chain = Chain.BITCOINIL;
    } else {
  ...
  getPreferredBalanceUnit() {
    if(this._isIl) {
      for (const value of Object.values(BitcoinilUnit)) {
