...
const WalletTransactions = () => {
  ...
  const [isManageFundsModalVisible, setIsManageFundsModalVisible] = useState(
    false,
  )
  ...
  useEffect(() => {
    setOptions({
      headerTitle:
        walletTransactionUpdateStatus === walletID
  ...
  const renderListFooterComponent = () => {
    ...
    return (
      (getTransactionsSliced(Infinity).length > limit && (
            ...
            <BlueListItem
              ...
              onPress={() => {
                const availableWallets = [
                  ...wallets.filter(
                    (item) => item.chain === Chain.ONCHAIN && item.allowSend(),
                  ),
                ]
      ...
      ios:
        wallet.getBalance() > 0 ? (
          ...
          >
            ...
            />
            <Text
              style={[styles.marketpalceText2, stylesHook.marketpalceText2]}
            >
              {loc.wallets.list_marketplace}
            </Text>
          </TouchableOpacity>
  ...
  const sendButtonPress = () => {
    ...
    if (
      ...
      wallet.isHd() &&
      !wallet.useWithHardwareWalletEnabled()
    ) {
      return Alert.alert(
        ...
        <FlatList
          ...
          ListEmptyComponent={
            ...
            >
              ...
              {isLightning() && (
                <Text style={styles.emptyTxsLightning}>
                  {loc.wallets.list_empty_txs2_lightning}
                </Text>
              )}
              ...
              {!isLightning() && (
                ...
                >
                  <Text testID="NoTxBuyBitcoin" style={styles.buyBitcoinText}>
                    {wallet._isIl
                      ? loc.wallets.list_tap_here_to_buy1
                      : loc.wallets.list_tap_here_to_buy}
                  </Text>
                </TouchableOpacity>
              )}
...
WalletTransactions.navigationOptions = navigationStyle(
  {},
